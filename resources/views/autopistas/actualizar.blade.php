    ...
    <div class="col-xs-10 col-md-10 col-md-offset-1">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form method="POST" action="{{ route('autopistas.modificar', $autopista) }}" role="form">
                    @csrf
                    {{ method_field('PATCH') }}
                    <div class="box-body">
                         <div class="form-group">
                            <label for="descripcion">Nombre:</label>
                            <input type="text" name="descripcion" class="form-control" placeholder="Nombre de la autopista" value="{{ $autopista->descripcion }}">
                        </div>
                        <div class="form-group">
