    ...
    public function guardar(Request $request, Autopista $autopista)
    {
        ...
        if ($tramos) {
            $request->validate([
                ...
                'cadenamiento_inicial_m'  => 'required|numeric|min:' . $tramos->cadenamiento_final_m . '|max:' . $tramos->cadenamiento_final_m . '|digits_between:000,999',
            ...
            $request->validate([
                ...
                'cadenamiento_inicial_m'  => 'required|numeric|max:' . $autopista->cadenamiento_inicial_m . '|digits_between:000,999',
